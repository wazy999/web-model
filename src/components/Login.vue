...
<div class="login" id="login">
    ...
    <div class="log-bg">
        ...
        <div class="log-text">家居模拟登录界面</div>
    </div>
    <div class="log-email">
...
export default {
  ...
  created(){
    console.log(this.$apis.LoginApi)
  },
  methods:{
      ...
      //请求接口
      // this.$axios.post(this.$apis.LoginApi,loginParam)
      // .then(res => {
      //   console.log(res)
      // })
  		// setTimeout(()=>{
...
.log-cloud{background-image: url(../assets/image/login-cloud.png); width: 63px ;height: 40px; position: absolute; z-index: 1}
...
.log-bg{background: url(../assets/image/login-bg.jpg); width: 100%; height: 312px; overflow: hidden;}
...
.icons{background:url(../assets/image/icons.png) no-repeat; display: inline-block;}
